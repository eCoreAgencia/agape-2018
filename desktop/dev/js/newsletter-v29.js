...
function ClientCreate(){
    ...
    $.ajax({
        ...
        success: function (data) {
          ...
          $('<div class="success-msg"><img class="col-md-3" src="/arquivos/img-legal-news.png" /><div class="col-md-9"><h3>Obrigado!</h3><br/>Agora você terá R$ 10 de desconto na sua primeira compra no site. Use o cupom <strong>PRIMEIRACOMPRA</strong> no carrinho de compras para ganhar seu benefício.</div></div>').appendTo('.Newsletter');
        },
        error: function (data) {
          console.log(data);
        }
