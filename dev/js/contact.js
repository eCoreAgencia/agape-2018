...
function FormCreate(storeName, dataEntity, htmlElementId, messageLoading, messageValidation, messageSuccess, messageError){
  ...
  htmlContent +=      '<option value="parceiro">Quero ser parceiro</option>'
  htmlContent +=      '<option value="rh">Quero entrar em contato com o RH</option>'
  htmlContent +=      '<option value="cidade">Quero sugerir uma cidade</option>'
  htmlContent +=      '<option value="desconto">Quero sugerir um desconto</option>'
